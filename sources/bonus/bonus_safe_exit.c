...
/*   Updated: 2025/04/23 01:35:21 by jveras           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cube3d.h"

static void	free_ceiling_floor_textures(t_texture_data ceiling_floor_textures[2], void *mlx)
{
	int	i;
	...
	while (i < 2)
	{
		if (ceiling_floor_textures[i].tex_ptr != NULL)
		{
			mlx_destroy_image(mlx, ceiling_floor_textures[i].tex_ptr);
			ceiling_floor_textures[i].tex_ptr = NULL;
		}
		i++;
	}
}
...
{
	free_ceiling_floor_textures(program->ceiling_floor.ceiling_floor_textures, program->mlx);
